...
//            2011-01-15 v0.14 ap added #define OPENDECODER22 22
//
//------------------------------------------------------------------------
//
...
//                 see: www.opendcc.de
//
#define OPENDECODER22 22
//  OPENDECODER2:  this board has:
//                 - ATmega8535, 16A, 32A, 164, 324 or 644 @ 11059200 Hz 
//                 - 8 Powerports with integrated feedback (for 4 switches)
//                 - 2 Servo connectors
//                 - RS-bus feedback
...
#define SERVO_ENABLED		FALSE	// TRUE: include code and data for servo control
...
#define RSBUS_ENABLED		FALSE	// TRUE: We use RS-bus feedbacks (requires Hardware 22)
...
// Decoder Model Configuration Check
 ...
 #if (RSBUS_ENABLED == TRUE)
  #warning: RS-bus feedback disabled - Reason: only supported with OPENDECODER22
  #undef RSBUS_ENABLED
  #define RSBUS_ENABLED   FALSE
 #endif
#endif
