...
//       see RP 9.2.2 for more information
    ...
    unsigned char compilat[] PROGMEM = {".... SERVO ..."};
    #if (SEGMENT_ENABLED == TRUE)
      unsigned char compilat1[] PROGMEM = {"..+ SEG ..."};
    #endif
    #if (PORT_ENABLED == TRUE)
      unsigned char compilat2[] PROGMEM = {"..+ PORT ..."};
    #endif
    ...
    t_cv_record CV_PRESET PROGMEM =
      {
        #include "cv_data_servo.h"
      };

#elif (DMX_ENABLED == TRUE)
   unsigned char compilat[] PROGMEM = {".... DMX ...."};
   ...
   unsigned char compilat[] PROGMEM = {".... RELAY + REVERSER ...."};
